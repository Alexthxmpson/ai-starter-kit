...
> **Info — Provisioning users and groups using SCIM**
> The SCIM API is available for workspaces in Notion's Enterprise Plan.

> **Info — Setting up single sign-on (SSO) with Notion**
> Single sign-on (SSO) can be configured for workspaces in Notion's Enterprise Plan.
